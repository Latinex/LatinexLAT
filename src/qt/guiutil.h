...
/** Utility functions used by the Latinex Qt UI.
 */
namespace GUIUtil
{
...
// Render Latinex addresses in monospace font
...
// Parse "Latinex:" URI into recipient object, return true on successful parsing
