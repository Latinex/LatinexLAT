/* src/config/Latinex-config.h.  Generated from Latinex-config.h.in by configure.  */
/* src/config/Latinex-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://latinex.la"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Latinex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Latinex Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Latinex"
