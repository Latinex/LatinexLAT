...
#if defined(NDEBUG)
#error "Latinex cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	else if (nHeight < 50 && nHeight > 0) { //Premine phase 1.000,000 coins in this phase 20k coins each block for 50 blocks
		nSubsidy = 20000 * COIN;
	}
...
{
	int64_t ret = 0;
	ret = blockValue * 0.7; //MN Gets 80% block reward
	return ret;
}
