...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Latinex server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Latinex features */
        {"Latinex", "masternode", &masternode, true, true, false},
        {"Latinex", "listmasternodes", &listmasternodes, true, true, false},
        {"Latinex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Latinex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Latinex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Latinex", "masternodedebug", &masternodedebug, true, true, false},
        {"Latinex", "startmasternode", &startmasternode, true, true, false},
        {"Latinex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Latinex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Latinex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Latinex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Latinex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Latinex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Latinex", "mnbudget", &mnbudget, true, true, false},
        {"Latinex", "preparebudget", &preparebudget, true, true, false},
        {"Latinex", "submitbudget", &submitbudget, true, true, false},
        {"Latinex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Latinex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Latinex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Latinex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Latinex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Latinex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Latinex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Latinex", "checkbudgets", &checkbudgets, true, true, false},
        {"Latinex", "mnsync", &mnsync, true, true, false},
        {"Latinex", "spork", &spork, true, true, false},
        {"Latinex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Latinex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Latinexd, or the -server option to Latinex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Latinex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39126/\n";
}
