...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Latinex Core Latinex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Latinex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Latinex transaction") + "\n" +
                               "  Latinex-tx [options] -create [commands]   " + _("Create hex-encoded Latinex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Latinex transaction
