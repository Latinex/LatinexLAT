/* src/config/concierge-config.h.  Generated from concierge-config.h.in by configure.  */
/* src/config/concierge-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.concierge.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Concierge Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Concierge Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "concierge"
