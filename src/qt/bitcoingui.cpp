                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Latinex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Latinex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Latinex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Latinex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Latinex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Latinex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Latinex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Latinex addresses"));
    ...
    openAction->setStatusTip(tr("Open a Latinex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Latinex Core help message to get a list with possible Latinex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Latinex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Latinex network", "", count));
}
...
{
    QString strTitle = tr("Latinex Core"); // default title
